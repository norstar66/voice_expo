...
function App() {
  ...
  // Unified State
  const [activeTab, setActiveTab] = useState<StationId | 'HISTORY' | 'PREP_ORDER'>('GRILL/SAUTE1');
  const STATIONS: StationId[] = ['GRILL/SAUTE1', 'SAUTE2', 'FRY', 'SALAD', 'PIZZA', 'EXPO', 'SERVER'];
    ...
    <div style={{ 
      ...
      <header style={{ 
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
          ...
          <button 
            onClick={() => setActiveTab('PREP_ORDER')}
            style={{ 
              backgroundColor: activeTab === 'PREP_ORDER' ? 'var(--color-accent)' : 'var(--color-secondary)',
              color: activeTab === 'PREP_ORDER' ? '#000' : '#fff',
              borderColor: 'transparent',
              flex: '1 0 auto',
              fontWeight: 'bold',
              textTransform: 'uppercase',
